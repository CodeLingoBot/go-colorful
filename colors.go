...
// AlmostEqualRgb checks for equality between colors within the tolerance Delta (1/255).
...
// DistanceCIE76: That's actually the same, but I don't want to break code.
